package debug.optimize.level1rename;
...
public class SearchAndVerifyEachResultBySubjectTest {
	...
	By HOME_LI_SUBJECT = By.xpath("//*[@id='searchTypeUl']/li[2]");
	By HOME_INPUT_KEYWORD = By.id("txtSearch");
	By HOME_SPAN_SEARCH_ICON = By.id("searchButtonGO");
	
	/* Result list page elements */
	By RL_LINK_RECORD_LINKS = By.xpath("//*[@id='resulttable']/tbody/tr/td[3]/div/h5/a");
	
	/* Record detail page elements */
	By RD_SPAN_FIRST_MATCHED_SUBJECT = By.xpath("(//span[contains(text(), 'Subject')]/../following-sibling::div/span)[1]");
