...
public class AdvancedSearchbyKeywodsInSubjectTest extends SeleniumTestAbstract {
	...
	String dropdownOptionKeywordsInSubject = "Keyword in Subject";

	@Test
	public void loginwithComplexaction() {
		LoginPageUtil.login(userName, password);
		HomePageUtil.enterAdvancedSearchPage();
		AdvancedSearchPageUtil
				.search(keyword, dropdownOptionKeywordsInSubject);
		...
		for (int i = 0; i < recordCount; i++) {
			...
			String str1 = DetailedInfoPageUtil.getMacthcedSubjectwithChina();
