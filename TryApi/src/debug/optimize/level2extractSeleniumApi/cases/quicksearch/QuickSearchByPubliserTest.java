...
public class QuickSearchByPubliserTest extends SeleniumTestAbstract {
	...
	public void loginwithComplexaction() {
		...
		HomePageUtil.searchByPublisher(keyword);
		...
		for (int i = 0; i < recordCount; i++) {
			...
			String str1 = DetailedInfoPageUtil.getMacthcedPublisherwithChina();
		...
		System.out.println("totoal find " + matchedCount
				+ " kind of book with publisher China");
	}
