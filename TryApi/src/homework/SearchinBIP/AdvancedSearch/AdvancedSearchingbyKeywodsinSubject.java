...
public class AdvancedSearchingbyKeywodsinSubject {
	...
	By RD_SPAN_FIRST_MATCHED_SUBJECT = By
			.xpath("//*[contains(text(),'Sears Subject')]/../following-sibling::div/span/a[1]");

	// Test data
	String userName = "SelAdmin";
	String password = "12345678";
	String keywords = "china";
	String dropdownoption_keywordsinSubject = "Keyword in Subject";
	...
	private void fillCondtioninAdvancedpage(WebDriver driver) {
		...
		dropdown.selectByVisibleText(dropdownoption_keywordsinSubject);
		// click search button
