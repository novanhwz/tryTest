...
public class SimpleCharacterWithoutPublicClass {
...
private static final String SIGN_IN_LINK = "http://aws.preprod.booksinprint.com/";
	...
	By HOME_LI_CHARACTER = By.xpath("//*[@id='searchTypeUl']/li[7]");
	...
	By RD_SPAN_FIRST_MATCHED_SUBJECT = By.xpath("//span[contains(text(),' Character')]/../following-sibling::div/span");
	...
	public void loginwithComplexaction(){
        ...
        System.out.println("totoal find "+matchedCount+" kind of book with Charater China");
	...
	private void search(WebDriver driver, String keyword) {
        ...
        driver.findElement(HOME_SPAN_KEYWORD_TYPE)
        	.findElement(HOME_LI_CHARACTER).click();
