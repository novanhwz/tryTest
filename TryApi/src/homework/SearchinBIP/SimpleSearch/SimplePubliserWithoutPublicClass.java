...
public class SimplePubliserWithoutPublicClass {
...
private static final String SIGN_IN_LINK = "http://aws.preprod.booksinprint.com/";
	...
	By HOME_LI_PUBLISHER = By.xpath("//*[@id='searchTypeUl']/li[5]");
	...
	By RD_SPAN_FIRST_MATCHED_SUBJECT = By.xpath("(//span[contains(text(),'Publisher')])[1]/../following-sibling::div/span/a[1]");
	...
	public void loginwithComplexaction(){
        ...
        System.out.println("totoal find "+matchedCount+" kind of book with publisher China");
	...
	private void search(WebDriver driver, String keyword) {
        ...
        driver.findElement(HOME_SPAN_KEYWORD_TYPE)
        	.findElement(HOME_LI_PUBLISHER).click();
